    ...
    for (auto vh : openMesh.vertices()) {
        ...
        for (auto heh : openMesh.voh_range(vh)) {
            if (!openMesh.is_boundary(heh)) {
                ...
                Eigen::Vector3f v1 = {
                    static_cast<float>(p1[0]-p2[0]),
                    static_cast<float>(p1[1]-p2[1]),
                    static_cast<float>(p1[2]-p2[2])
                };
                Eigen::Vector3f v2 = {
                    static_cast<float>(p3[0]-p2[0]),
                    static_cast<float>(p3[1]-p2[1]),
                    static_cast<float>(p3[2]-p2[2])
                };
                Eigen::Vector3f v3 = {
                    static_cast<float>(p4[0]-p2[0]),
                    static_cast<float>(p4[1]-p2[1]),
                    static_cast<float>(p4[2]-p2[2])
                };
