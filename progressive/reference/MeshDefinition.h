...
typedef OpenMesh::PolyMesh_ArrayKernelT<MeshTraits> ProgressiveMesh;

bool is_flip_ok_openmesh(ProgressiveMesh::EdgeHandle& eh, ProgressiveMesh& mesh_);//just copy the code from openmesh
bool flip_openmesh(ProgressiveMesh::EdgeHandle& eh, ProgressiveMesh& mesh_);
